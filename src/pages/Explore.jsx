export default function Explore({ darkMode = false }) {
    return (
        <div className="p-6 md:p-10 pb-24 flex flex-col items-center justify-center text-center min-h-screen">
            <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${darkMode ? 'bg-gray-800' : 'bg-gray-200'}`}>
                <span className="text-2xl">🔍</span>
            </div>
            <h1 className={`text-lg font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Explore Campus</h1>
