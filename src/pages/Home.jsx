...
export default function Home({ darkMode = false }) {
    ...
    return (
        <div className="max-w-4xl mx-auto md:p-8 p-5 pb-24 transition-colors duration-300">
            {/* Desktop Header for Home */}
            <div className="hidden md:flex justify-between items-end mb-8">
                <div>
                    <h2 className={`text-base font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Refocus Your Day</h2>
