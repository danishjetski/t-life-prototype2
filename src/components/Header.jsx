        ...
        >
            ...
            <div className="flex items-center gap-3">
                <div className="relative">
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#E31837] to-[#8a1525] flex items-center justify-center text-white font-serif font-bold text-lg shadow-glow-red border border-white/10">
                        T
                    </div>
                </div>
                <div>
